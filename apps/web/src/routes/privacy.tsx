    ...
    <main className="mx-auto max-w-2xl p-6">
      ...
      {isTr ? (
        <div className="prose mt-6 space-y-4 text-slate-700">
          ...
          <h2 className="text-xl font-semibold">Nasıl kullanıyoruz</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold">Haklarınız (KVKK / GDPR)</h2>
          <ul className="list-disc pl-5">
        ...
        <div className="prose mt-6 space-y-4 text-slate-700">
          ...
          <h2 className="text-xl font-semibold">Your rights (KVKK / GDPR)</h2>
          <ul className="list-disc pl-5">
