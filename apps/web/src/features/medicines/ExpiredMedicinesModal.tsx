    ...
    >
      ...
      <div className="animate-fade-in relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            <h2 id="expired-alert-title" className="font-bold text-slate-900">
        ...
        <ul className="mb-5 max-h-56 space-y-2 overflow-y-auto rounded-xl border border-slate-200 bg-slate-50 p-3">
          {medicines.map((m) => (
